...
(function () {
  ...
  function satir(c, i, acik) {
    ...
    return '' +
      '<article class="cum' + (acik ? ' acik' : '') + '" data-i="' + i + '" data-sid="' + kimlik(c) + '" role="button" tabindex="0" aria-expanded="' + !!acik + '" aria-label="Çeviriyi göster: ' + kacar(c.e) + '">' +
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    function listeCevir(e) {
      ...
      k.setAttribute('aria-expanded', String(!tr.hidden));
    }
